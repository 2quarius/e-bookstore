...
<el-container>
	...
	<el-menu-item :index="'/selfcenter'||'/admin'" @click="store">个人中心</el-menu-item>
	<el-menu-item index="/logout" @click="logout" style="float:right;">退出</el-menu-item>
</el-menu>
	</el-header>
	<el-main>
		<router-view/>
